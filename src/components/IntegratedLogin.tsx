...
export default function IntegratedLogin({ onLoginSuccess, onBackToSurvey }: IntegratedLoginProps) {
        ...
        <div className="bg-slate-800 rounded-lg shadow-2xl border border-slate-700 p-8">
          ...
          <div className="text-center mb-8">
            <div className="flex justify-center mb-4">
              <img src={logo} alt="Valenzuela Logo" className="w-20 h-20 rounded-full" />
            </div>
