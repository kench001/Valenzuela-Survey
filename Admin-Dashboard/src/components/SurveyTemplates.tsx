  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-white">Survey Templates</h1>
      ...
      {/* Popular Templates */}
      <div>
        <h2 className="text-white mb-4">Popular Templates</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates.filter(t => t.popular).map((template) => (
            <Card key={template.id} className="hover:border-red-500 transition-colors">
      ...
      {/* All Templates */}
      <div>
        <h2 className="text-white mb-4">All Templates</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates.filter(t => !t.popular).map((template) => (
            <Card key={template.id} className="hover:border-red-500 transition-colors">
              <div className="flex items-start justify-between mb-3">
